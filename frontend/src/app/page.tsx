                ...
                <form className="w-full flex flex-col gap-4">
                  ...
                  <div className="flex gap-4">
                    <label className="input  w-full">
                      ...
                      <input type="text" required placeholder="First Name" name="firstname" value={formData.firstname} onChange={(e) => setFormData({ ...formData, firstname: e.target.value })} />
                    </label>
                    <label className="input  w-full">
                      <FontAwesomeIcon icon={faUser} className="h-5 w-5 opacity-50" />
                      <input type="text" required placeholder="Last Name" name="lastname" value={formData.lastname} onChange={(e) => setFormData({ ...formData, lastname: e.target.value })} />
                    </label>
                  </div>
