...
import { faBell, faEnvelope, faHome, faHashtag, faUsers, faEllipsisH, faFeather, faSearch, faSignOutAlt, faUser, faCog } from "@fortawesome/free-solid-svg-icons";
        ...
        <aside className="w-20 lg:w-1/5 flex flex-col justify-between p-2 lg:p-4 bg-base-200 border-r border-base-200">
            ...
            <div className="relative flex flex-col items-center lg:items-start space-x-0 space-y-1 mt-6">
                <div className="dropdown dropdown-top ">
                    ...
                    <ul tabIndex={0} className="dropdown-content menu p-2 shadow rounded-box w-40 bg-base-300">
                        <li>
